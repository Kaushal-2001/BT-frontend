            ...
            <div id="carouselExampleCaptions" className="carousel slide">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="../images/brain-logo.png" className="d-block w-100" alt="..."/>
                    ...
                    <div className="carousel-item">
                        <img src="../images/brain-low-resolution-logo-black-on-transparent-background.png" className="d-block w-100" alt="..."/>
                            <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item">
                        <img src="..images/brain1.png" className="d-block w-100" alt="..."/>
                            <div className="carousel-caption d-none d-md-block">
